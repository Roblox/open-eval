...
eval.reference = function()
	local merryScript = game:GetService("Workspace").Playground.MerryGoRound:FindFirstChildWhichIsA("Script")
	merryScript.Source = merryScript.Source:gsub(
		"if%s+randNum%s*>=%s*40%s*then.-end",
		""
	)
end
